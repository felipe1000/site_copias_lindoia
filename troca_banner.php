...
<div id="container">
 ...
 <div id="meio">
  <div id="meio_esquerda">
   ...
   ?>
      <iframe width="595" height="600" frameborder="0" scrolling="yes" src="trocas_layout.html"></iframe>
  </div><!-- fecha div meio direita-->
</div><!--fecha div meio-->
 <div id="rodape"></div>
</div> <!--fecha container-->
</body>
