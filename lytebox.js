...
function Lytebox(bInitialize, aHttp) {
	...
	/*** Configure Lytebox ***/
		...
		this.theme   			= (typeof lyteboxTheme !== 'undefined') && /^(black|grey|red|green|blue|gold|orange)$/i.test(lyteboxTheme) ? lyteboxTheme : 'green'; // themes: black (default), grey, red, green, blue, gold, orange
